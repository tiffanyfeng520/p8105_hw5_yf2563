...
```
    ...
    ##    <int>     <int>    <dbl>    <dbl> <chr>         
    ##  1     1         1   1.00   0.996    Fail to Reject
    ##  2     1         2   0.181  0.480    Fail to Reject
    ##  3     1         3  -0.832  0.0691   Fail to Reject
    ##  4     1         4  -1.65   0.00650  Reject        
    ##  5     1         5   0.0227 0.256    Fail to Reject
    ##  6     1         6  -0.0519 0.264    Fail to Reject
    ##  7     1         7   1.12   0.903    Fail to Reject
    ##  8     1         8  -1.89   0.000936 Reject        
    ##  9     1         9   1.16   0.876    Fail to Reject
    ## 10     1        10   0.468  0.596    Fail to Reject
