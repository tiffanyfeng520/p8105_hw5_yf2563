...
#### Plot2
  ...
  - Make a second plot (or overlay on the first) the average estimate of
    ...
    the true value of mu on the x axis. Is the sample average of mu
    across tests for which the null is rejected approximately equal to
    the true value of mu? Why or why not?
