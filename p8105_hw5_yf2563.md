...
```
    ...
    ##    <dbl>     <int>    <dbl>   <dbl> <chr>         
    ##  1     0         1    0.180  0.817  Fail to Reject
    ##  2     0         2    1.32   0.0852 Fail to Reject
    ##  3     0         3   -0.753  0.379  Fail to Reject
    ##  4     0         4   -0.906  0.395  Fail to Reject
    ##  5     0         5    1.36   0.116  Fail to Reject
    ##  6     0         6    0.365  0.730  Fail to Reject
    ##  7     0         7    2.22   0.0115 Reject        
    ##  8     0         8   -1.70   0.0242 Reject        
    ##  9     0         9    0.473  0.619  Fail to Reject
    ## 10     0        10    0.407  0.593  Fail to Reject
    ## # … with 4,990 more rows

``` r
output = map_dfr(0:6, simulation)
...
```
    ...
    ##       mu sample_id estimate p.value decision      
    ##    <int>     <int>    <dbl>   <dbl> <chr>         
    ##  1     0         1   -0.712   0.436 Fail to Reject
    ##  2     0         2   -1.04    0.159 Fail to Reject
    ##  3     0         3    0.660   0.459 Fail to Reject
    ##  4     0         4    1.23    0.165 Fail to Reject
    ##  5     0         5    0.449   0.642 Fail to Reject
    ##  6     0         6    0.540   0.473 Fail to Reject
    ##  7     0         7    1.10    0.262 Fail to Reject
    ##  8     0         8    0.182   0.852 Fail to Reject
    ##  9     0         9   -0.610   0.449 Fail to Reject
    ## 10     0        10   -1.03    0.118 Fail to Reject
...
<img src="p8105_hw5_yf2563_files/figure-gfm/unnamed-chunk-11-1.png" width="90%" />
